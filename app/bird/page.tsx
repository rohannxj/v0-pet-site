...
import { ChevronRight, Wheat, Home, Sparkles, Package, Heart, Droplets } from "lucide-react"

const subcategories = [
  { name: "Food & Seed", icon: Wheat, count: 98, href: "/shop/bird?category=food", color: "bg-amber-100 text-amber-700" },
  { name: "Cages", icon: Home, count: 45, href: "/shop/bird?category=cages", color: "bg-blue-100 text-blue-700" },
  { name: "Toys", icon: Sparkles, count: 67, href: "/shop/bird?category=toys", color: "bg-purple-100 text-purple-700" },
  { name: "Accessories", icon: Package, count: 54, href: "/shop/bird?category=accessories", color: "bg-emerald-100 text-emerald-700" },
  { name: "Health", icon: Heart, count: 32, href: "/shop/bird?category=health", color: "bg-red-100 text-red-700" },
  { name: "Baths & Care", icon: Droplets, count: 28, href: "/shop/bird?category=care", color: "bg-cyan-100 text-cyan-700" },
]
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4">
              ...
              <div className="flex gap-4">
                ...
                <Link href="/shop/bird?category=food">
